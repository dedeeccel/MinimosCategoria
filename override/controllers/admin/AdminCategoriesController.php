    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->l('Mínimos', 'OrderController'),
                    'name' => 'minimos',
                    'required' => false,
                    'class' => 'minimos',
                    'values' => array(
                        array(
                            'id' => 'desligado',
                            'value' => 0,
                            'label' => $this->l('Desligado', 'OrderController')
                        ),
                        array(
                            'id' => 'quantidade',
                            'value' => 1,
                            'label' => $this->l('Por quantidade', 'OrderController')
                        ),
                        array(
                            'id' => 'valor',
                            'value' => 2,
                            'label' => $this->l('Por valor', 'OrderController')
                        )
                ...
                array(
                    'type' => 'text',
                    'width' => 100,
                    'label' => $this->l('Quantidade mínima', 'AdminCategories'),
                    'name' => 'quantidademinima',
                    'hint' => $this->l('Insira a quantidade mínima desta categoria.', 'OrderController')
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Preço mínimo', 'OrderController'),
                    'prefix' => $currency->sign,
                    'name' => 'precominimo',
                    'hint' => $this->l('Insira o valor mínimo desta categoria.', 'OrderController')
                ),
                array(
                    'type' => 'categories',
